...
var module = {
  en: {
    ...
    messages: {
      ...
      last_name: "Last name",
      landing_hero_parraf:
        "une creates all kind of sculptures with felt and does workshops where you can learn how to do felt art yourself. In the blog you can see all the pieces and discover the story behind them. Don't forget visit the shop and get the perfect gift.",
      landing_text_desert:
        "Under the ocre color egg cover is a kind lady named miss desert. She is the ambassador of the desert kingdom. ",
      landing_text_forest:
        "Under the green color egg cover is a kind and peaceful lady named miss forest. She is the ambassador of the forest kingdom.",
      landing_text_tundra:
        "Under the grass green egg cover is an energetic lady named miss wetland. She is the ambassador of the wetland kingdom.",
